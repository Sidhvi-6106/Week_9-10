...
export const navbarClass =
  "bg-[var(--nav-bg)] backdrop-blur-xl backdrop-saturate-150 border-b border-[#e8e8ed] min-h-[68px] flex items-center sticky top-0 z-50";
export const navContainerClass = "max-w-7xl mx-auto w-full flex items-center justify-between px-6 sm:px-10";
...
export const navLinkClass = "text-[0.95rem] sm:text-base text-[#424245] hover:text-[#1d1d1f] transition-colors font-semibold";
export const navLinkActiveClass = "text-[0.95rem] sm:text-base text-[#0066cc] font-bold";
